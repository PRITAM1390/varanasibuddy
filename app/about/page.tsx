        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-white rounded-xl p-8 border" style={{ borderColor: 'rgba(200,120,40,0.2)' }}>
            ...
            <div className="flex items-center gap-4 mb-6">
              <div style={{ width: '64px', height: '64px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '24px', fontWeight: 'bold', flexShrink: 0, backgroundColor: 'rgba(245,200,66,0.2)', color: '#F5C842', fontFamily: 'Playfair Display, serif' }}>
                P
              </div>
              <div>
                <div className="font-bold text-lg" style={{ color: 'var(--text-dark)' }}>Pritam</div>
                <div className="text-sm" style={{ color: 'var(--text-mid)' }}>Founder, {config.businessName}</div>
                <div className="text-xs" style={{ color: 'var(--text-mid)' }}>{config.city}, Uttar Pradesh</div>
              </div>
            </div>
            ...
            <p className="text-sm mb-4" style={{ color: 'var(--text-mid)', lineHeight: '1.8' }}>
              I started {config.businessName} because I wanted every visitor to experience Varanasi the way locals do — with honesty, warmth and no confusion about where to go or what to pay.
            </p>
            <p className="text-sm" style={{ color: 'var(--text-mid)', lineHeight: '1.8' }}>
              You deserve the real Varanasi — the Ganga aarti at dawn, authentic street food, a fair boat ride on the river. That's exactly what we're here for.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
            {[
              ...
              <div key={i} className="bg-white rounded-xl p-6 text-center border"
                style={{ borderColor: 'rgba(200,120,40,0.2)' }}>
                <div style={{ width: '48px', height: '48px', borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: '0 auto 12px', fontWeight: 'bold', fontSize: '18px', backgroundColor: 'rgba(245,200,66,0.2)', color: '#F5C842', fontFamily: 'Playfair Display, serif' }}>
                  {member.initial}
                </div>
          ...
          <p className="text-center text-xs mt-4" style={{ color: 'var(--text-mid)' }}>* Update your team members' names in the code anytime!</p>
        </div>
      </section>
